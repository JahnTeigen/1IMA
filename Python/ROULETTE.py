...
class roulette:
    ...
    def checkBets(self, betPick, betMin):
        ...
        for i in betPick:
            if int(i) < betMin or int(i) > betMax:
                print('Error: '+str(i)+' == an invalid bet')
                if self.rouletteStyle == 'American':
                    print('Please roll again with a bet between -1 and 36. American roulette has 38 diferent possible numbers, where 00 == represented as -1')
                else:
                    print('Please roll again with a bet between -1 and 36. American roulette has 38 diferent possible numbers, where 00 == represented as -1')
                return(False)
        return(True)        
    ...
    def roll(self, betAmmount, betPick=None):
        ...
        #   Check to see if the bet ammount == valid, if not break
        if float(betAmmount) <= 0.0:
            print('Error: You have bet an incorrect ammount. All bets must be greater than 0.0')
            return()
        
        #   Check to see if there == enough money in the bank account
        ...
        if self.betType == 'Straight':
            if self.rouletteStyle == 'American':
                ...
                if int(betPick) < -1 or int(betPick) > 36:
                    print('Error: You have picked an incorrect bet, please roll again with a bet between -1 and 36. American roulette has 38 diferent possible numbers, where 00 == represented as -1')
                    return()
                else:
        ...
        #   Begin a row betting game
            ...
            if self.rouletteStyle == 'American':
                ...
                print('Sorry row betting == only allowed on the American roulette wheel. Please set the roullete style to American by roulette.(rouletteStyle="American")')
                return()
        #   Begin a split betting game, where you can pick any two numbers
            ...
            if self.rouletteStyle == 'American':
                ...
                if int(betPick[0]) < -1 or int(betPick[0]) > 36:
                    print('Error: You have picked an incorrect bet for your first number, please roll again with a bet between -1 and 36. American roulette has 38 diferent possible numbers, where 00 == represented as -1')
                    return()
                elif int(betPick[1]) < -1 or int(betPick[1]) > 36:
                    print('Error: You have picked an incorrect bet for your second number, please roll again with a bet between -1 and 36. American roulette has 38 diferent possible numbers, where 00 == represented as -1')
                    return()
                else:
                    theRoll = self.rollTheRouletteWheel()
                    print('You bet the ball would land on '+str(betPick))
        ...
        #   Begin a street betting game, where you can pick any three numbers
            ...
            if self.rouletteStyle == 'American':
                ...
                if int(betPick[0]) < -1 or int(betPick[0]) > 36:
                    ...
                    print('Error: You have picked an incorrect bet for your third number, please roll again with a bet between -1 and 36. American roulette has 38 diferent possible numbers, where 00 == represented as -1')
                    return()
                else:
                    theRoll = self.rollTheRouletteWheel()
                    print('You bet the ball would land on '+str(betPick))
        ...
        #   Begin a Corner betting game, where you can pick any four numbers
            ...
            if self.rouletteStyle == 'American':
                ...
                if int(betPick[0]) < -1 or int(betPick[0]) > 36:
                    ...
                    print('Error: You have picked an incorrect bet for your fourth number, please roll again with a bet between -1 and 36. American roulette has 38 diferent possible numbers, where 00 == represented as -1')
                    return()
                else:
                    theRoll = self.rollTheRouletteWheel()
                    print('You bet the ball would land on '+str(betPick))
